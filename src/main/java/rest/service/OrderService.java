...
public interface OrderService {
    ...
    /** Indicateurs d'aide a la decision pour un produit (mois courant) : frequence d'achat (nb BL distincts),
     * quantite totale entree, derniere entree (date + qte), stock reserve. */
