 ...
 *
 * Copie de vente/user/AddCarnet.js, orientee « je suis dans le depot ».
 ...
 * vente/user/AddCarnet.js doit etre reportee ici.
 *
...
Ext.define('testextjs.view.vente.endepot.AddCarnet', {
    extend: 'Ext.window.Window',
    xtype: 'addCarnetwindowdepot',
    autoShow: false,
    height: 450,
    width: '70%',
    modal: true,
