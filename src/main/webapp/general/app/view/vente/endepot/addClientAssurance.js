 ...
 *
 * Copie de vente/user/addClientAssurance.js, orientee « je suis dans le depot ».
 ...
 * vente/user/addClientAssurance.js doit etre reportee ici.
 *
 * Le xtype est distinct pour que les selecteurs du controleur de l'officine ne rencontrent
 * jamais cet ecran, et inversement.
 */
Ext.define('testextjs.view.vente.endepot.addClientAssurance', {
    extend: 'Ext.window.Window',
    xtype: 'addaddclientwindowdepot',
    autoShow: false,
    height: 600,
    width: '70%',
    modal: true,
