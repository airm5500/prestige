 ...
 *
 * Copie de vente/user/ClientGrid.js, orientee « je suis dans le depot ».
 ...
 * vente/user/ClientGrid.js doit etre reportee ici.
 *
...
Ext.define('testextjs.view.vente.endepot.ClientGrid', {
    extend: 'Ext.window.Window',
    xtype: 'assuranceClientdepot',
    autoShow: false,
    height: 400,
    width: '60%',
    modal: true,
